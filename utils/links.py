class Website:
    def __init__(self,display_name:str,common_name:str,PS5_link:str):
        self.display_name=display_name
        self.common_name=common_name
        self.PS5_link=PS5_link
        
# All_Websites={
#     "flipkart":Website(display_name="Flipkart",common_name="flipkart",PS5_link="https://www.flipkart.com/sony-playstation-5-cfi-1008a01r-825-gb-astro-s-playroom/p/itma0201bdea62fa"),
#     "amazon":Website(display_name="Amazon",common_name="amazon",PS5_link="https://www.amazon.in/dp/B08FV5GC28"),
